            ...
            >
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12'>
                ...
                >
                  ...
                  />
                  <h3
                    className={`text-lg font-black mb-2 transition-colors duration-500 ${
              ...
              >
                <div className='space-y-12'>
                  ...
                  <section>
                    <h2
                      className={`text-3xl font-black mb-6 transition-colors duration-500 ${
                        isDarkMode ? 'text-white' : 'text-gray-900'
                      }`}
                    >
                    ...
                    <div
                      className={`text-lg font-bold leading-relaxed space-y-4 transition-colors duration-500 ${
                        isDarkMode ? 'text-gray-300' : 'text-gray-600'
                      }`}
                    >
                      <p>
                        Estos Términos de Servicio ("Términos") rigen el uso de la aplicación Mood Log App ("la
                        Aplicación", "nuestro Servicio") operada por nuestro equipo ("nosotros", "nuestro", "la
                        Compañía").
                      </p>
                      <p>
                        Al acceder y usar nuestra aplicación, aceptas estar sujeto a estos Términos. Si no estás de
                        acuerdo con alguna parte de estos términos, no debes usar nuestro Servicio.
                      </p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    >
                      ...
                      <p className='mt-4'>
                        ...
                        <Link
                          to='/privacy'
                          className={`font-black transition-colors duration-500 hover:scale-105 ${
                            isDarkMode
                    ...
                    >
                      <div className='flex items-start space-x-3'>
                        ...
                        <div>
                          ...
                          >
                            Mood Log App no reemplaza el consejo médico profesional. Siempre consulta con un profesional
                            de salud mental para asuntos serios.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div
                      className={`text-lg font-bold leading-relaxed mt-6 transition-colors duration-500 ${
                        isDarkMode ? 'text-gray-300' : 'text-gray-600'
                      }`}
                    >
                  ...
                  <section>
                    ...
                    >
                      ...
                      <p className='mt-4'>
                        El uso continuado del servicio después de los cambios constituye aceptación de los nuevos
                        términos.
                      </p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    >
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                        ...
                        >
                          <Mail
                            className={`w-6 h-6 mb-3 transition-colors duration-500 ${
                              isDarkMode ? 'text-purple-400' : 'text-purple-600'
                            }`}
                          />
                          <h4
                            className={`text-sm font-black mb-2 transition-colors duration-500 ${
                              isDarkMode ? 'text-white' : 'text-gray-900'
                            }`}
                          >
                            EMAIL
              ...
              {/* Footer */}
              <div
                className={`mt-12 pt-8 border-t-2 transition-colors duration-500 ${
              ...
              >
                <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
                  ...
                  <div className='flex space-x-6'>
                    <Link
                      to='/privacy'
                      className={`text-sm font-bold transition-colors duration-500 hover:scale-105 ${
