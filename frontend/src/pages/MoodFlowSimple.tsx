        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            <div className='flex items-center space-x-2 sm:space-x-4'>
              ...
              <button
                onClick={() => {
                  // Preservar modo oscuro al navegar
            ...
            <div className='grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-10 gap-3 mb-8'>
              {moodEmojis.map((emoji, index) => (
                <button
                  ...
                  className={`p-3 sm:p-4 rounded-xl border-2 transition-all duration-200 hover:scale-105 hover:shadow-lg flex flex-col items-center justify-center min-h-[100px] ${
                    currentMood === index + 1
                ...
                >
                  ...
                  <div className={`text-xs sm:text-sm font-medium text-center break-words ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                    {moodLabels[index]}
                  </div>
                  <div className={`text-xs sm:text-sm font-bold mt-1 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>
                    {index + 1}/10
                  </div>
                </button>
              ))}
