import { BarChart3, BookOpen, Calendar, LogOut, Menu, Moon, Settings, Sun, X } from 'lucide-react';
          ...
          <div className='flex justify-between items-center py-3 sm:py-4'>
            ...
            <div className='flex items-center space-x-2 sm:space-x-4'>
              ...
              <button
                ...
                className={`touch-target flex items-center space-x-1 sm:space-x-2 px-2 sm:px-4 py-2 rounded-lg transition-colors text-sm sm:text-base ${
                  isDarkMode
